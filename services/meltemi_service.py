...
def process_query(query: str) -> str:
    messages = [
        {"role": "system",
         "content": "You are an AI assistant capable of answering questions and calling functions when necessary. Available functions: get_current_weather(location: str, unit: str = 'celsius')"},
...
if __name__ == "__main__":
    ...
    print("Regular query:")
    print(process_query("Πες μου ένα αστείο για πειρατές"))

    print("\nFunction calling query:")
    print(process_query("Τι καιρό κάνει αυτή τη στιγμή στην Θεσσαλονίκη;"))
